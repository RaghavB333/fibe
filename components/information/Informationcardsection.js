...
const Informationcardsection = ({title, description, cardData, p, showButton}) => {
  return (
    <section className="px-6 lg:px-8 py-20 lg:py-32" id="eligbilitycriteria">
        <div className="text-center">
            ...
            {p && <p className="font-semibold max-w-5xl mx-auto text-base lg:text-xl mb-8">{p}</p>}
        </div>
        <div className={`grid grid-cols-${cardData.length/2} lg:grid-cols-2 xl:grid-cols-${cardData.length} gap-7 lg:gap-8 lg:max-w-screen-2xl justify-items-center mt-8 container mx-auto [&>*]:bg-latte [&>*]:p-5 [&>*]:rounded-xl [&>*]:max-w-lg [&>*]:w-full [&>*]:group [&>*]:pointer`}>
        ...
        {showButton && <div className="flex justify-center items-center mt-8">
