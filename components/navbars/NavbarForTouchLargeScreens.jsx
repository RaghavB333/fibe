...
const NavbarForTouchLargeScreens = () => {
    ...
    return (
        <nav className='fixed flex z-[9999] w-full top-0 bg-gradient-to-t from-[#FFF1F5] to-[#FFF8ED] px-2 py-3 justify-between'>
                ...
                <li className="group">
                    <div className="flex items-center gap-1 cursor-pointer">
                        ...
                        <svg
                            ...
                            height="6"
                            fill="none"
                            className="stroke-gray-500 mt-1 group-hover:stroke-blue-500"
                        >
                            <path d="M1 1L6 5L11 1" strokeWidth="1.5" />
                        </svg>
                        <ul
                            className={`absolute mt-68 left-10 bg-white rounded-xl shadow-xl z-50 w-[32vw] p-4 space-y-4 text-sm transform origin-top transition duration-300 ease-in-out
    ${activeDropdown === 'loans' ? 'scale-y-100 opacity-100' : 'scale-y-0 opacity-0'}
  `}>
                ...
                <li className="relative group">
                    <div className="flex items-center gap-1 cursor-pointer">
                        ...
                        <button onClick={() => setActiveDropdown(activeDropdown === 'OO' ? null : 'OO')} className="hover:cursor-pointer">Our Offerings</button>
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="12"
                            height="6"
                        ...
                        <ul
                            className={`absolute mt-[52vh] left-10 bg-white rounded-xl shadow-xl z-50 w-[32vw] p-4 space-y-4 text-sm transform origin-top transition duration-300 ease-in-out
    ${activeDropdown === 'OO' ? 'scale-y-100 opacity-100' : 'scale-y-0 opacity-0'}
  `}>

                            {/* Left column */}
                            <div className="flex flex-col w-full space-y-6 ">
                                <span className='my-2 text-[17px]'>Newly Launched</span>
                                <Link href={"/"} className='flex hover:bg-[rgb(254,249,235)] p-1 rounded-lg group/item'>
                                    ...
                                    <div className='flex flex-col justify-center'>
                                        <div className='lg:pl-2 flex'> <span>Loan against mutual funds</span>
                                ...
                                <Link href={"/"} className='flex hover:bg-[rgb(254,249,235)] p-1 rounded-lg group/item'>
                                    ...
                                    <div className='flex flex-col justify-center'>
                                        <div className='lg:pl-2 flex'> <span>Salary Advance</span>
                                            <span className="text-black ml-2 inline-block transform transition-transform duration-300 ease-in-out group-hover/item:translate-x-2">
                                                →
                                            </span>
                                        </div>
                                ...
                                <Link href={"/"} className='flex  hover:bg-[rgb(254,249,235)] p-1 rounded-lg group/item'>
                                    ...
                                    <div className='flex flex-col justify-center'>
                                        <div className='lg:pl-2 flex'> <span>Fibe Axis Bank Credit Card</span>
                                            <span className="text-black ml-2 inline-block transform transition-transform duration-300 ease-in-out group-hover/item:translate-x-2">
                                                →
                                            </span>
                                        </div>
                            ...
                            <div className='flex flex-col gap-4'>
                                ...
                                <Link href={"/"} className='flex  hover:bg-[rgb(254,249,235)] p-1 rounded-lg group/item'>
                                    ...
                                    <div className='flex flex-col justify-center'>
                                        <div className='lg:pl-2 flex'> <span>Medical Loan</span>
                                            <span className="text-black ml-2 inline-block transform transition-transform duration-300 ease-in-out group-hover/item:translate-x-2">
                                                →
                                            </span>
                                        </div>
                                ...
                                <Link href={"/"} className='flex  hover:bg-[rgb(254,249,235)] p-1 rounded-lg group/item'>
                                    ...
                                    <div className='flex flex-col justify-center'>
                                        <div className='lg:pl-2 flex'> <span>Solar Loan</span>
                                            <span className="text-black ml-2 inline-block transform transition-transform duration-300 ease-in-out group-hover/item:translate-x-2">
                                                →
                                            </span>
                                        </div>
                ...
                <li className="relative group">
                    <div className="flex items-center gap-1 cursor-pointer">
                        ...
                        <button onClick={() => setActiveDropdown(activeDropdown === 'LC' ? null : 'LC')} className="hover:cursor-pointer">Loan Calculators</button>
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="12"
                            height="6"
                        ...
                        <ul
                            className={`absolute mt-96 left-10 bg-white rounded-xl shadow-xl z-50 w-[32vw] p-4 space-y-4 text-sm transform origin-top transition duration-300 ease-in-out
    ${activeDropdown === 'LC' ? 'scale-y-100 opacity-100' : 'scale-y-0 opacity-0'}
  `}>
                            <div className='flex flex-col gap-4'>
                                ...
                                <Link href={"/"} className='flex  hover:bg-[rgb(254,249,235)] p-1 rounded-lg group/item'>
                                    ...
                                    <div className='flex flex-col justify-center'>
                                        <div className='lg:pl-2 flex'> <span>Loan EMI Calculator</span>
                                            <span className="text-black ml-2 inline-block transform transition-transform duration-300 ease-in-out group-hover/item:translate-x-2">
                                                →
                                            </span>
                                        </div>
                                ...
                                <Link href={"/"} className='flex  hover:bg-[rgb(254,249,235)] p-1 rounded-lg group/item'>
                                    ...
                                    <div className='flex flex-col justify-center'>
                                        <div className='lg:pl-2 flex'> <span>Instant Loan EMI Calculator</span>
                                            <span className="text-black ml-2 inline-block transform transition-transform duration-300 ease-in-out group-hover/item:translate-x-2">
                                                →
                                            </span>
                                        </div>
                            ...
                            <div className='flex flex-col gap-4'>
                                <Link href={"/"} className='flex  hover:bg-[rgb(254,249,235)] p-1 rounded-lg group/item'>
                                    ...
                                    <div className='flex flex-col justify-center'>
                                        <div className='lg:pl-2 flex'> <span>Eligibilty Calculator</span>
                                            <span className="text-black ml-2 inline-block transform transition-transform duration-300 ease-in-out group-hover/item:translate-x-2">
                                                →
                                            </span>
                                        </div>
                                ...
                                <Link href={"/"} className='flex  hover:bg-[rgb(254,249,235)] p-1 rounded-lg group/item'>
                                    ...
                                    <div className='flex flex-col justify-center'>
                                        <div className='lg:pl-2 flex'> <span>Check Credit Card Score</span>
                                            <span className="text-black ml-2 inline-block transform transition-transform duration-300 ease-in-out group-hover/item:translate-x-2">
                                                →
                                            </span>
                                        </div>
                ...
                <li className="relative group">
                    <div className="flex items-center gap-1 cursor-pointer">
                        ...
                        <button onClick={() => setActiveDropdown(activeDropdown === 'L' ? null : 'L')} className="hover:cursor-pointer">Learn</button>
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="12"
                            height="6"
                        ...
                        <ul
                            className={`absolute mt-52 left-0 bg-white rounded-xl shadow-xl z-50 w-[34vw] p-4 space-y-4 text-sm transform origin-top transition duration-300 ease-in-out
    ${activeDropdown === 'L' ? 'scale-y-100 opacity-100' : 'scale-y-0 opacity-0'}
  `}>
                            ...
                            <Link href={"/"} className='flex  hover:bg-[rgb(254,249,235)] p-1 rounded-lg group/item'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="24" fill="none"><path stroke="#333" strokeLinecap="round" strokeWidth="1.5" d="M8 6h8m4 12V6a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v12a4 4 0 0 0 4 4h8a4 4 0 0 0 4-4Z"></path><path fill="#F8A63F" d="M8.75 10a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0ZM12.75 10a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0ZM16.75 10a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0ZM8.75 18a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0ZM12.75 18a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0ZM16.75 18a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Z"></path></svg>
                                <div className='flex flex-col justify-center'>
                                    <div className='lg:pl-2 flex'> <span>Blogs</span>
                                        <span className="text-black ml-2 inline-block transform transition-transform duration-300 ease-in-out group-hover/item:translate-x-2">
                                            →
                                        </span>
                                    </div>
                            ...
                            <Link href={"/"} className='flex  hover:bg-[rgb(254,249,235)] p-1 rounded-lg group/item'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="22" fill="none"><path stroke="#333" strokeWidth="1.5" d="M17 1H5a4 4 0 0 0-4 4v12a4 4 0 0 0 4 4h12a4 4 0 0 0 4-4V5a4 4 0 0 0-4-4Z"></path><path stroke="#F8A63F" strokeWidth="1.5" d="M15 9a2 2 0 0 0-2 2v2a2 2 0 1 0 4 0v-2a2 2 0 0 0-2-2ZM7 5a2 2 0 0 0-2 2v6a2 2 0 1 0 4 0V7a2 2 0 0 0-2-2Z"></path></svg>
                                <div className='flex flex-col justify-center'>
                                    <div className='lg:pl-2 flex'> <span>Financial Dictionary</span>
                                        <span className="text-black ml-2 inline-block transform transition-transform duration-300 ease-in-out group-hover/item:translate-x-2">
                                            →
                                        </span>
                                    </div>
                ...
                <li className="relative group">
                    <div className="flex items-center gap-1 cursor-pointer">
                        ...
                        <button onClick={() => setActiveDropdown(activeDropdown === 'A' ? null : 'A')} className="hover:cursor-pointer">About</button>
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="12"
                            height="6"
                        ...
                        <ul
                            className={`absolute mt-[30vh] left-0 bg-white rounded-xl shadow-xl z-50 w-[32vw] p-4 space-y-4 text-sm transform origin-top transition duration-300 ease-in-out
    ${activeDropdown === 'A' ? 'scale-y-100 opacity-100' : 'scale-y-0 opacity-0'}
  `}>
                            <div className='flex flex-col gap-4'>
                                ...
                                <Link href={"/"} className='flex  hover:bg-[rgb(254,249,235)] p-1 rounded-lg group/item'>
                                    ...
                                    <div className='flex flex-col justify-center'>
                                        <div className='lg:pl-2 flex'> <span>About Fibe</span>
                                            <span className="text-black ml-2 inline-block transform transition-transform duration-300 ease-in-out group-hover/item:translate-x-2">
                                                →
                                            </span>
                                        </div>
                                ...
                                <Link href={"/"} className='flex  hover:bg-[rgb(254,249,235)] p-1 rounded-lg group/item'>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="22" fill="none"><path stroke="#333" strokeWidth="1.5" d="M17 1H5a4 4 0 0 0-4 4v12a4 4 0 0 0 4 4h12a4 4 0 0 0 4-4V5a4 4 0 0 0-4-4Z"></path><path stroke="#F8A63F" strokeWidth="1.5" d="M15 9a2 2 0 0 0-2 2v2a2 2 0 1 0 4 0v-2a2 2 0 0 0-2-2ZM7 5a2 2 0 0 0-2 2v6a2 2 0 1 0 4 0V7a2 2 0 0 0-2-2Z"></path></svg>
                                    <div className='flex flex-col justify-center'>
                                        <div className='lg:pl-2 flex'> <span>Careers</span>
                                            <span className="text-black ml-2 inline-block transform transition-transform duration-300 ease-in-out group-hover/item:translate-x-2">
                                                →
                                            </span>
                                        </div>
                            ...
                            <div className='flex flex-col gap-4'>
                                <Link href={"/"} className='flex  hover:bg-[rgb(254,249,235)] p-1 rounded-lg group/item'>
                                    ...
                                    <div className='flex flex-col justify-center'>
                                        <div className='lg:pl-2 flex'> <span>News</span>
                                            <span className="text-black ml-2 inline-block transform transition-transform duration-300 ease-in-out group-hover/item:translate-x-2">
                                                →
                                            </span>
                                        </div>
                                ...
                                <Link href={"/"} className='flex  hover:bg-[rgb(254,249,235)] p-1 rounded-lg group/item'>
                                    ...
                                    <div className='flex flex-col justify-center'>
                                        <div className='lg:pl-2 flex'> <span>Contact Us</span>
                                            <span className="text-black ml-2 inline-block transform transition-transform duration-300 ease-in-out group-hover/item:translate-x-2">
                                                →
                                            </span>
                                        </div>
                ...
                <li className="relative group">
                    <div className="flex items-center gap-1">
                        ...
                        <button onClick={() => setActiveDropdown(activeDropdown === 'DF' ? null : 'DF')} className="hover:cursor-pointer">Download Fibe</button>
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="12"
                            height="6"
  ...
  `}>
                            <div className='flex flex-col'>
                                ...
                                <button onClick={handleClickApp} className='my-1 flex gap-2 justify-center w-60 ml-2 py-2 rounded-xl bg-black text-white hover:cursor-pointer hover:text-black hover:bg-white group/item hover:border'>
                                ...
                                <button onClick={handleClickPlay} className='flex gap-2 my-1 justify-center w-60 ml-2 py-2 rounded-xl bg-black text-white hover:cursor-pointer hover:text-black hover:bg-white group/item hover:border'>
...
export default NavbarForTouchLargeScreens
