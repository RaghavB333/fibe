...
const NavbarForTouchLargeScreens = () => {
  ...
  `}>
                            ...
                            <li className="group/item flex items-start gap-3 p-2 rounded-lg transition-all cursor-pointer hover:bg-[rgb(254,249,235)] hover:border border-gray-300">
                                ...
                                <div className="flex-1">
                                    <a href='/instant-cash-loan' className="font-medium text-black flex justify-between items-center">
                                        Instant Cash Loan
  ...
  `}>
                            ...
                            <div className="flex flex-col w-full space-y-6 ">
                                <span className='my-2 text-[14px]'>Newly Launched</span>
  ...
  `}>
                ...
                <li className="relative group">
                    <div className="flex items-center gap-1 cursor-pointer">
                        ...
                        <ul
                            className={`absolute mt-[30vh] bg-white rounded-xl shadow-xl z-50 w-[32vw] p-4 space-y-4 text-sm transform origin-top transition duration-300 ease-in-out
