    ...
    return (
        <div className='bg-[#f4faff] flex max-lg:flex-col justify-between gap-20 items-center px-16 py-10'>
            ...
            <div className='flex flex-col gap-10 w-[32vw] max-lg:w-[94vw] max-lg:text-center max-lg:gap-2 max-lg:items-center'>
                <h1 className='text-2xl font-bold'>The cool new vibe to finance</h1>
                <div className='text-[18px] font-semibold px-4 lg:px-0'>
                    Download the Fibe app the get instant cash anywhere
                </div>
                <div className='flex gap-4'>
                    <img className='h-[25vh] max-lg:hidden' src="https://www.fibe.in/_next/image/?url=%2Fappsflyer.png&w=256&q=75" alt="" />
                    <div className='flex flex-col justify-center mt-4 lg:mt-0 gap-4'>
                        <button onClick={handleClickApp} className='my-1 flex gap-2 justify-center items-center w-[60vw] lg:w-64 lg:h-16 py-2 rounded-lg font-medium bg-black text-white hover:cursor-pointer hover:text-black hover:bg-white hover:border hover:border-black group'>
                        ...
                        <button onClick={handleClickPlay} className='my-1 flex gap-2 justify-center items-center w-[60vw] lg:w-64 lg:h-16 py-2 rounded-lg font-medium bg-black text-white hover:cursor-pointer hover:text-black hover:bg-white hover:border hover:border-black group'>
                ...
                <div className='lg:hidden flex pr-24 mt-6'>
                    <img width={480} height={580} className="ms-16" src="https://www.fibe.in/_next/image/?url=%2Ffibe-mobile-girl.png&w=1080&q=75" alt="" />
                </div>
            </div>
