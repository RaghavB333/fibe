        ...
        <section className="px-6 lg:px-8 py-8 lg:pt-32 pt-20 container ">
            ...
            <div className="mx-auto pt-1 lg:pt-6 flex flex-col lg:hidden">
                ...
                <div className='lg:hidden h-0'>
                    <div className='w-1 bg-[#E6E6E6] relative h-[41px] bottom-[72.4vh] left-3.5'></div>
                    <div className='w-1 bg-[#E6E6E6] relative h-[64px] bottom-[68.5vh] left-3.5'></div>
                    <div className='w-1 bg-[#E6E6E6] relative h-[41px] bottom-[64.5vh] left-3.5'></div>
                    <div className='w-1 bg-[#E6E6E6] relative h-[65px] bottom-[60.7vh] left-3.5'></div>
                    <div className='w-1 bg-[#E6E6E6] relative h-[65px] bottom-[56.8vh] left-3.5'></div>
                    <div className='w-1 bg-[#E6E6E6] relative h-[65px] bottom-[53vh] left-3.5'></div>
