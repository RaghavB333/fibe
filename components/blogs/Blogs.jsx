            ...
            <div className='flex max-lg:flex-col px-6 lg:px-10 gap-4 lg:gap-8 mb-10'>
                ...
                <div className='w-1/2 flex flex-col gap-[6%] max-lg:gap-8 max-lg:w-full'>
                    <div className='h-[47%] w-full border border-gray-300 hover:border-[#079f9f] rounded-lg p-5 flex max-lg:flex-col '>
                        <div>
                            <img width={150} height={150} className='w-full lg:min-w-[15vw] max-lg: h-full object-cover lg:w-[215px] max-lg:h-64' src="https://www.fibe.in/_next/image/?url=https%3A%2F%2Faltcont.fibe.in%2Fwp-content%2Fuploads%2F2023%2F05%2FWhat-is-personal-loan-sanction-letter.png&w=384&q=100" alt="" />
                        </div>
                    ...
                    <div className='h-[47%] w-full border border-gray-300 hover:border-[#079f9f] rounded-lg p-5 flex max-lg:flex-col'>
                        <div>
                            <img width={150} height={150} className='w-full lg:min-w-[15vw] h-full object-cover lg:w-[215px] max-lg:h-64' src="https://www.fibe.in/_next/image/?url=https%3A%2F%2Faltcont.fibe.in%2Fwp-content%2Fuploads%2F2024%2F08%2FWhat-is-Video-KYC-How-to-prepare-for-a-V-KYC-for-Personal-Loan-application.jpg&w=384&q=100" alt="" />
                        </div>
                        <div className='flex flex-col'>
                            <div className='flex gap-4 items-center mt-1 lg:ml-4'>
                                <div className='text-[#079f9f] font-[550]'>Banking</div>
